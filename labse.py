...
# Loading LaBSE tokenizer and model
...
trainer.save_model('./labse_model')  # Save the model
tokenizer.save_pretrained('./labse_model')  # Save the tokenizer

# Saving the model using joblib for later use
joblib.dump(model, './labse_model/labse_trained_model.joblib')
